function capturarDados() {
    ...
    const aHTML = (document.getElementById("campo1"));
    const bHTML = (document.getElementById("campo2"));
    const cHTML = (document.getElementById("campo3"));
    ...
    if(!verificador){
        resultado = `<p>Valor de a não pode ser 0</p>
        <br>`;
    } else {
